...
export async function GET(request: Request, { params }: { params: { id: string, relationshipId: string } }) {
  try {
...
export async function PUT(request: Request, { params }: { params: { id: string, relationshipId: string } }) {
  try {
    const { id: projectId, relationshipId } = params;
...
export async function DELETE(request: Request, { params }: { params: { id: string, relationshipId: string } }) {
  try {
    const { id: projectId, relationshipId } = params;
